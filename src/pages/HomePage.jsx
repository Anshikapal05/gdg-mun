      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl px-6 py-16 text-center max-sm:py-10">
          ...
          <img
            src="/2025.png"
            alt="2025"
            className="mx-auto mt-6 h-56 md:h-72 max-sm:h-55 object-contain filter brightness-110"
            style={{
              filter:
          ...
          <p className="mt-6 text-gray-300 max-w-2xl mx-auto max-sm:text-sm max-sm:mt-4">
        ...
        {[
          {
            title: "Committees",
            description:
              "Explore dynamic agendas and topical issues curated by our EB.",
            icon: (
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-8 h-8 text-[#D4AF37] max-sm:w-6 max-sm:h-6"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          },
          {
            title: "Registration",
            description:
              "Secure your spot and be part of an unforgettable experience.",
            icon: (
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-8 h-8 text-[#D4AF37] max-sm:w-6 max-sm:h-6"
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M5.121 17.804A3.001 3.001 0 018 15h8a3.001 3.001 0 012.879 2.804M15 11a3 3 0 11-6 0 3 3 0 016 0z"
                />
              </svg>
            ),
          },
            ...
            icon: (
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M3 5a2 2 0 012-2h3.28a1 1 0 01.95.68l1.22 3.64a1 1 0 01-.27 1.05l-2.12 2.12a16.001 16.001 0 007.07 7.07l2.12-2.12a1 1 0 011.05-.27l3.64 1.22a1 1 0 01.68.95V19a2 2 0 01-2 2h-1C9.61 21 3 14.39 3 6V5z"
                />
              </svg>
            ),
          },
          ...
          <div
            key={idx}
            className="border border-[#D4AF37]/50 rounded-xl p-6 bg-black/40 flex items-center gap-4 hover:bg-black/60 hover:shadow-[0_0_15px_rgba(212,175,55,0.5)] transition duration-300
